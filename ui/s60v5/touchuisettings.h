...
class TTouchSettings {
    ...
    public:
        ...
        TPoint GetTbLandscapeMovePoint() { return iSaveLandscapeMovePoint; };        
        TBool GetTbLandscapeStartPlace() { return iSaveLandscapeIsStartPlaceTop; };        
        TPoint GetTbPortraitMovePoint() { return iSavePortraitMovePoint; };
        TBool GetTbPortraitStartPlace() { return iSavePortraitIsStartPlaceTop; };
        ...
        void SetTbLandscapeMovePoint(TPoint aCmd) { iSaveLandscapeMovePoint = aCmd; };        
        void SetTbLandscapeStartPlace(TBool aCmd) { iSaveLandscapeIsStartPlaceTop = aCmd; };        
        void SetTbPortraitMovePoint(TPoint aCmd) { iSavePortraitMovePoint = aCmd; };
        void SetTbPortraitStartPlace(TBool aCmd) { iSavePortraitIsStartPlaceTop = aCmd; };
        
        void SetDefault(); // Set default values
        
        void ReadSettingFileL(const TDesC &aFileName);
        void WriteSettingFileL(const TDesC &aFileName);
    ...
    private:
        ...
        //Points for saving toolbar position
        TPoint iSaveLandscapeMovePoint;        
        TBool iSaveLandscapeIsStartPlaceTop; 
        
        TPoint iSavePortraitMovePoint;
        TBool iSavePortraitIsStartPlaceTop;
